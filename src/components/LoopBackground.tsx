...
* Global Variables
*/
const VIEWBOX = "0 0 2035 1338" as const; // <-- use whatever your SVG exported

const CTA_LINE_PATHS: readonly CTALinePath[] = [
...
export function LoopBackground() {
    ...
    return (
        <div className="bg-layer pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
            <svg
              className="bg-svg"
              viewBox={VIEWBOX}
